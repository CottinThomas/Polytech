...
int main(int /*argc*/, char * * argv)
{
	...
	size_t const NB_ROW_A = 1500;
	size_t const NB_COL_A = 1500;
	size_t const NB_COL_B = 1500;
	...
	/*
		Inversion boucles k et j -> parcours dans le meme ordre
